...
export default function PlumberProfile({ onNavigate, onLogout }: PlumberProfileProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-[#F4F8FB] relative">
      {/* Header */}
      <div className="bg-gradient-to-br from-[#007AFF] to-[#0051D5] px-4 lg:px-6 pt-14 pb-16 lg:pt-6 lg:pb-20">
        <div className="max-w-4xl mx-auto">
          <Button 
            variant="ghost" 
            size="icon"
            onClick={() => onNavigate('plumber-home')}
            className="lg:hidden mb-2 text-white hover:bg-white/20 -ml-2"
          >
            <ArrowLeft className="w-5 h-5" />
          </Button>
          <h1 className="text-xl lg:text-2xl text-white mb-0.5">Professional Profile</h1>
          <p className="text-white/80 text-xs">Your business information and credentials</p>
        </div>
      </div>

      {/* Profile Card - Overlapping Header */}
      <div className="flex-1 overflow-y-auto -mt-10 px-4 lg:px-6 pb-24 lg:pb-8">
        <div className="max-w-4xl mx-auto">
