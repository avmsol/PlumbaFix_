...
export default function JobDetails({ onNavigate, job, onTrackJob }: JobDetailsProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-[#F4F8FB]">
      {/* Header */}
      <div className="bg-white px-4 lg:px-6 pt-14 pb-4 lg:pt-6 lg:pb-4 border-b border-gray-100">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4 mb-2">
            ...
            <div className="flex-1">
              <h1 className="text-xl lg:text-2xl mb-0.5">Job Details</h1>
      ...
      <div className="flex-1 overflow-y-auto p-6 lg:p-8 pb-24 lg:pb-8">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          {/* Pending Approval Alert and Button */}
          {isPendingApproval && (
            <Card className="p-5 border-amber-200 bg-amber-50">
              <div className="flex items-start gap-3 mb-4">
                <AlertCircle className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
                <div>
                  <h3 className="text-amber-900 mb-1">Work Completed - Approval Required</h3>
                  <p className="text-sm text-amber-700">
                    Your plumber has completed the work. Please review and approve to release payment.
                  </p>
                </div>
              </div>
              <Button 
                className="w-full h-12 bg-[#00C853] hover:bg-green-700 rounded-xl gap-2"
          ...
          {!isCompleted && !isPendingApproval && job.jobType === 'plumber' && job.status !== 'pending' && (
            <Button 
