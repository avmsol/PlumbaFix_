...
export default function UserDashboard({ onNavigate, userProfile, onViewJob }: UserDashboardProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-white relative">
      {/* Header */}
      <div className="px-4 lg:px-6 pt-14 pb-4 lg:pt-6 lg:pb-4 border-b border-gray-100">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="lg:flex-1">
              <h1 className="text-xl lg:text-2xl mb-0.5">My Dashboard</h1>
              <p className="text-gray-500 text-xs">Track your progress and achievements</p>
            </div>
            <Button 
              variant="ghost" 
              size="icon"
