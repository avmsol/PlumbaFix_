...
import { Settings, DollarSign, Clock, Wrench, MapPin, Camera, ChevronRight, FileText, AlertCircle } from 'lucide-react';
...
type ActiveTab = 'quote-requests' | 'pending-quotes';
...
export default function PlumberHome({ onNavigate, onSwitchView, onSelectQuoteRequest }: PlumberHomeProps) {
  const [activeTab, setActiveTab] = useState<ActiveTab>('quote-requests');
  ...
  return (
    <div className="h-full overflow-y-auto bg-[#F4F8FB]">
      ...
      <div className="p-6 pt-0">
        ...
        <Card className="p-4 mb-6 border-amber-200 bg-gradient-to-br from-amber-50 to-white">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <h3 className="text-gray-900">Pending Customer Approval</h3>
                <Badge className="bg-amber-500 text-white hover:bg-amber-500">2</Badge>
              </div>
              <p className="text-sm text-gray-600 mb-3">
                You have 2 completed jobs waiting for customer approval. Payment will be released once approved.
              </p>
              <Button
                size="sm"
        ...
        {/* Active Requests Tabs */}
        <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as ActiveTab)} className="w-full">
          <TabsList className="grid w-full grid-cols-2 h-auto p-1 bg-white border border-gray-200 rounded-xl mb-6">
            <TabsTrigger 
          ...
          {/* Pending Quotes Tab */}
          <TabsContent value="pending-quotes" className="mt-0">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
