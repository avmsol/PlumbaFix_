...
export default function PlumberQuoteReview({ onNavigate, quoteRequest, onSubmitQuote }: PlumberQuoteReviewProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-[#F4F8FB] relative">
      ...
      <div className="bg-white px-4 lg:px-6 pt-14 pb-4 lg:pt-6 lg:pb-4 border-b border-gray-100">
        <div className="max-w-4xl mx-auto">
          <Button 
            ...
            className="mb-2 lg:hidden -ml-2"
          >
            <ArrowLeft className="w-5 h-5" />
          </Button>
          <h1 className="text-xl lg:text-2xl mb-0.5">Review Quote Request</h1>
          <p className="text-gray-500 text-xs">Review details and submit your quote</p>
        </div>
      </div>
      ...
      {/* Submit CTA - Mobile */}
      <div className="absolute bottom-24 left-0 right-0 bg-white border-t border-gray-100 p-4 lg:hidden shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        <Button 
          onClick={handleSubmitQuote}
          disabled={!laborCost || !partsCost || !estimatedTime}
          className="w-full h-12 bg-[#007AFF] hover:bg-[#0051D5] rounded-xl gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
